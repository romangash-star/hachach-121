...
Regenerate:  python3 explorations/build_v4.py
"""
...
.lane1 .art{min-height:120px;flex:none;height:244px;background:#C0B393;
...
.lane1 .hl{background:linear-gradient(104deg,rgba(0,0,0,0) 0,var(--hl) 1.5%,var(--hl) 98%,rgba(0,0,0,0) 100%);
  ...
  mix-blend-mode:multiply}
.lane1 .source{color:#332D22;font-weight:700;letter-spacing:.05em;font-size:11.5px;
  border-top:1px dashed #8E8264;padding-top:10px}
...
.lane2 .source{padding-top:11px;border-top:1px solid #DDD9D0;font-size:14px;
  font-weight:700;color:#1A1A1A}
.lane2 .source .ico-link{width:15px;height:15px;color:#787C7E}
.lane2 .source-name{border-bottom:2px solid #C9A227;padding-bottom:1px}
...
.lane3 .art{flex:none;height:252px;margin-top:-44px;overflow:visible;z-index:4}
.lane3 .art-emoji{width:268px;height:268px;display:grid;place-items:center;font-size:0;
...
.lane3 .art-emoji::before{content:"🪖";font-size:170px;line-height:1;
...
.lane3 .source{font-weight:800;padding-top:14px}
